...
- Разработчики с коммерческим опытом, и начинающие разработчики, написавшие [шестой проект](https://zhukovsd.github.io/java-backend-learning-course/projects/task-tracker/) моего роадмапа, или аналогичный по сложности
...
- Уровни зарплат - от 160 до 400к, в зависимости от запросов и возможностей кандидата

### Наша статистика

С мая 2024 по июль 2026 включительно трудоустроено 120 человек, получено 349 офферов, медиана - 240к. Процент успешного прохождения испыталок - 92.93%.
...
Если коммерческого опыта нет, условие по вашему уровню - у вас написан шестой проект [роадмапа](https://zhukovsd.github.io/java-backend-learning-course/projects/task-tracker/), или аналогичный по сложности.

Почему это важно - последние проекты близки по уровню сложности задач к реальным рабочим задачам на среднестатистических Middle позициях, и опыт работы с ними повышает ваши шансы успешно пройти испытательный срок.

Необходимо наличие минимум двух ревью на ваши реализации проектов. Обязательный минимум - ревью на один из последних двух проектов, и на один из проектов с 2 по 5. Больше ревью - лучше.

Способы получить ревью:
- Каждый месяц я спонсирую ревью на 15-20 проектов, присылаемых в [чат сообщества](https://t.me/zhukovsd_it_chat)
- По [учебной подписке](/services/student-subscription/) доступно одно ревью в месяц
- Список менторов сообщества, доступных для ревью, можно посмотреть [тут](https://docs.google.com/spreadsheets/d/1DkIIcE6oUtcK9jjfrOyUgatb6DIxL5GXEn3kvUp4Lms/edit?gid=0#gid=0)

Ревью показывает, насколько ваш уровень соответствует медианному уровню коммерческой разработки. Коллекция ревью сообщества доступна [здесь](https://zhukovsd.github.io/java-backend-learning-course/finished-projects/). 
