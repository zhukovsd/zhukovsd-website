...
Необходимо наличие ревью на ваши реализации проектов. Минимум - на последние 2. Больше - лучше.
...
Ревью показывает, насколько ваш уровень соответствует медианному уровеню коммерческой разработки. Коллекция ревью сообщества доступна [здесь](https://zhukovsd.github.io/java-backend-learning-course/finished-projects/). 
