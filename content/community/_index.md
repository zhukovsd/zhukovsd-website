...
- [Чат](https://t.me/zhukovsd_it_chat) на 2000 человек
- 125 трудоустройств с моей прямой помощью в период с февраля 2024 по август 2026
- 1650+ написанных проектов, 890+ публичных ревью - [https://zhukovsd.github.io/java-backend-learning-course/finished-projects/](https://zhukovsd.github.io/java-backend-learning-course/finished-projects/)
- 26 [менторов](https://docs.google.com/spreadsheets/d/1_EaS3CRoBeo-PG04O2YGOYSk3afdGxgeqd3x0WRLe68/edit?gid=0#gid=0), групповые активности на 190+ человек в месяц
...
- [Коллекция](https://zhukovsd.github.io/java-backend-learning-course/finished-projects/) из 1650+ реализаций проектов роадмапа на Java, Python, Go, Kotlin, C#, ...
- [Воркшопы](https://docs.google.com/spreadsheets/d/1HmF7UzEeDHdMd0zEjnXqUa0Aaa2JkK0h3NfotT41nT0/edit?gid=0#gid=0)
- **[$]** Эталонные реализации на проекты "Виселица", "Симуляция", "Обмен валют", "Теннисное табло" доступны в рамках [учебной подписки](/services/student-subscription/)
...
- [Методичка](https://zhukovsd.github.io/python-backend-interview-prep/) для подготовки к собеседованиям на позицию Python Backend.
- **[$]** [Менторство по трудоустройству](/services/employment-mentorship/) - сопровождение до оффера. С февраля 2024 по август 2026 включительно получено 364 оффера, трудоустроено 125 человек.
- **[$]** [Валютные удалёнки](/services/global-remote-employment/) - сопровождение до оффера на валютную удалёнку.
