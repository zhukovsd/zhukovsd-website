...
- Если проблема найдена, и не совсем понятно как её решать - поиском по заметкам найти те видео, в которых я её разбирал (ссылки на заметки к каждому ревью есть в [списке реализаций](https://zhukovsd.github.io/java-backend-learning-course/finished-projects/))
- Послушать ревью, если вопросы остались, задать в [чате](https://telegram.me/zhukovsd_it_chat)
