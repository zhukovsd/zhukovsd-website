...
- [Коллекция реализаций](https://github.com/zhukovsd/java-backend-learning-course/tree/main/content/finished-projects) проектов студентами и ревью к ним
...
- В конце каждого месяца публикую на канале свежие реализации проектов, ревью, [истории успеха](https://telegram.me/zhukovsd_it_chat/56150)
- [Парное менторство](https://zhukovsd.it/posts/pair-mentorship-announce/) помогает новичкам учиться под руководством опытных товарищей (Java менторов дефицит, желающие, [пишите](https://telegram.me/zhukovsd))
